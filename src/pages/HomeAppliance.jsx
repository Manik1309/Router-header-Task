...
const HomeAppliance = ({products}) => {
    return (
        <div>
            <div>
            <h1 className='text-black font-extrabold text-2xl'>HOME APPLIANCE</h1>
            <div className=" grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6 p-4">   
      {products.filter(product => ( product.category === "home appliances")).map(product => (
        <div key={product.id}            
